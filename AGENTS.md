...
- Use functional and declarative programming patterns; avoid classes (exception: secure storage modules use the class-based dual-export pattern described above)
...
// Props should be defined at the top of the component
type Props = {
  text: string;
};
